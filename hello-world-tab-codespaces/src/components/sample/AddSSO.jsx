...
export function AddSSO(props) {
  ...
  return (
    <div>
      ...
      <p>
        One of the advantages of building tab application in Teams is to
        leverage the user's identity provided through Microsoft Teams (Known as{" "}
      ...
      <p>
        Starting with this simple static tab app, you can follow few steps to
        add SSO logics to authenticate users, retrieve user's profile photo, and
        build UI layers with{" "}
