...
export function Introduce() {
  return (
    <div>
      ...
      <p>
        Please read more about custom Graph connectors in this <a href="https://docs.microsoft.com/en-us/graph/connecting-external-content-connectors-overview" target="_blank" rel="noreferrer">document</a>.
      </p>
    </div>
  );
}
