...
1. [Submit the Teams app to the Teams Admin Center](https://docs.microsoft.com/en-us/microsoftteams/platform/toolkit/publish#publish-to-your-organization).

    > **Note**: If you are testing with 'Local Debug' in a new debug session, you need to delete the existing Teams app in Teams Admin Center and publish a new one, since the ngrok endpoint will change when you start a new debug session.
