...
export class NotificationHandler {
    static async processGraphWebhookChangeNotification(req: restify.Request) {
        ...
        if (targetConnectorState === TargetConnectorState.Enabled) {
            ...
            const csvFileContent = (await readFile(path.join(__dirname, "..", "assets", "ApplianceParts.csv"))).toString();
            ...
            for (const item of records) {
                ...
                await graphService.createExternalItem(connectionId, item.PartNumber, externalItem);
            }
