...
- From Microsoft 365 Agents Toolkit CLI: Start debugging the project by executing the command `teamsapp preview --env local` in your project directory.
